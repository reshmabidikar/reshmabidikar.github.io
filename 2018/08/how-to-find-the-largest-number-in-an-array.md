...
public static void main(String\[\] args) { Integer\[\] intArr = {45,21,88,210,550,1,34}; int max = 0; for(int num:intArr){ if(num > max) max = num; } System.out.println("Biggest number is "+max);
